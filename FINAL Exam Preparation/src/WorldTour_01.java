        ...
        while (!input.equals("Travel")){
            ...
            switch (commandName){
                ...
                case "Remove Stop":
                    ...
                    if(removeBeginIndex >= 0 && removeBeginIndex < initialDestination.length() && removeEndIndex >= 0
                            && removeEndIndex < initialDestination.length()){
                ...
                case "Switch":
                    ...
                    String destination  = initialDestination.toString();
                    destination = destination.replace(oldString,newString);
                    initialDestination = new StringBuilder(destination);
                    System.out.println(initialDestination);
                    break;
            }
