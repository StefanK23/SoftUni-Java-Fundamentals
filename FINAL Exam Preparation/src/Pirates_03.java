...
public class Pirates_03 {
    public static void main(String[] args) {
        ...
        while (!userInput.equals("End")) {
            ...
            String[] commandPart = userInput.split("=>");
            String commandName = commandPart[0];
            String cityName = commandPart[1];

            switch (commandName) {
                case "Plunder":
                    int peopleKilled = Integer.parseInt(commandPart[2]);
                    int goldStolen = Integer.parseInt(commandPart[3]);
                    ...
                    break;
                case "Prosper":
                    int goldProsper = Integer.parseInt(commandPart[2]);
                    if(goldProsper< 0 ){
